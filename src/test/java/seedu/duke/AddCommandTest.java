...
public class AddCommandTest {
    ...
    public void execute_singleExpense_expenseAddedToList() {
        ...
        Ui ui = new Ui();
        // FIX: Replaced null category with "Others" to bypass interactive UI prompt
    ...
    public void execute_multipleExpenses_expensesAddedCorrectly() {
        ...
        // FIX: Replaced null categories to bypass interactive UI prompt
    ...
    public void execute_zeroAmount_expenseAddedWithZeroAmount() {
        ...
        // FIX: Replaced null category to bypass interactive UI prompt
